<script lang="ts">
  ...
  <button
    ...
    style:--bg={background}
    class={cn(
      "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-5 py-2 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-white",
